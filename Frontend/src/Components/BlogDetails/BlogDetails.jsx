...
const provider = "Uniqe Record Of Universe"; // Your provider name
const url = window.location.href;
const message = `${blog.blogTitle}\n\n©Provider: ${provider}\n\nRead link ⬇️\n${url}`;
...
const handleShareLinkedIn = () => {
  const linkedInUrl = `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(url)}&title=${encodeURIComponent(blog.blogTitle)}&summary=${encodeURIComponent(message)}`;
...
const handleShareEmail = () => {
  ...
  <Helmet>
    ...
    <meta 
      ...
      content={blog.blogContent.replace(/<[^>]+>/g, "").substring(0, 200)} 
    />
          ...
          <div className="News-details-community">
            <div className="News-details-tags-row">
             ...
             <div className="social-share">
                <strong>Share:</strong>
                <button className="social-news-icon fb" onClick={handleShareFacebook}>
                  <FontAwesomeIcon icon={["fab", "facebook-f"]} />
                </button>
                <button className="social-news-icon x" onClick={handleShareTwitter}>
                  <FontAwesomeIcon icon={["fab", "twitter"]} />
                </button>
                <button className="social-news-icon linkedin" onClick={handleShareLinkedIn}>
                  <FontAwesomeIcon icon={["fab", "linkedin-in"]} />
                </button>
                <button className="social-news-icon wa" onClick={handleShareWhatsApp}>
                  <FontAwesomeIcon icon={["fab", "whatsapp"]} />
                </button>
                <button className="social-news-icon telegram" onClick={handleShareTelegram}>
                  <FontAwesomeIcon icon={["fab", "telegram-plane"]} />
                </button>
                <button className="social-news-icon more" onClick={handleShareEmail}>
