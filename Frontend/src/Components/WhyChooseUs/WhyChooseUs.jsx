...
const WhyChooseUs = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "Dr. Avishek Kumar is a writer of a nature type and in his writings, social aspects, human welfare/change, natural, environmental facts are described in detail. Along with this, things related to animal, animal and bird welfare are seen in great detail.",
      className: "support",
    },
    {
      icon: <FaBook />,
    ...
    return (
      <div key={index} className={`card ${card.className}`}>
        ...
        {card.description.length > 300 && (
          <button
            className="about-why-choose-us-readmore"
