...
export default function CurrentMonthSalesChart() {
  ...
  const series = [
    {
      ...
      data: [120, 300, 450, 280, 600, 550, 720, 400, 350, 680, 790, 430],
    },
  ];
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative inline-block">
          ...
          <Dropdown isOpen={isOpen} onClose={closeDropdown} className="w-40 p-2">
            ...
            <DropdownItem onItemClick={closeDropdown}>Export Data</DropdownItem>
          </Dropdown>
        </div>
      </div>
